...
@dag(
    ...
    catchup=False,
    tags=["software_engineering", "product_a"],
)
def software_eng_prod_dag_a():
    @task(outlets=[Dataset(f"bq://{CORE_PROJECT_ID}.product_a.product_logs_v1")])
    def complex_task_1():
